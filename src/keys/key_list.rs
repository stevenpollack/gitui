...
pub struct KeysList {
	...
	pub diff_toggle_syntax: GituiKeyEvent,
	pub diff_toggle_split: GituiKeyEvent,
...
impl Default for KeysList {
	fn default() -> Self {
		Self {
			...
			diff_toggle_syntax: GituiKeyEvent::new(KeyCode::Char('X'),  KeyModifiers::SHIFT),
			diff_toggle_split: GituiKeyEvent::new(KeyCode::Char('V'),  KeyModifiers::SHIFT),
			...
			diff_base: GituiKeyEvent::new(KeyCode::Char('v'),  KeyModifiers::empty()),
